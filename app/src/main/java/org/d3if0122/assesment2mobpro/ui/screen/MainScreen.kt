...
import org.d3if0122.assesment2mobpro.navigation.Screen
import org.d3if0122.assesment2mobpro.ui.theme.Assesment2MobproTheme
import org.d3if0122.assesment2mobpro.util.SettingsDataStore
    ...
    Scaffold (
        topBar = {
            TopAppBar(title = {
                ...
                actions = {
                    IconButton(
                        onClick = { CoroutineScope(Dispatchers.IO).launch { dataStore.saveLayout(!showList) } }) {
                        Icon(
